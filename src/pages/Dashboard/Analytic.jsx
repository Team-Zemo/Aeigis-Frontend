    ...
    data: [
      {
        ...
        data: aiMisuseData.monthlyMisuse.map((d) => ({
          x: d.month,
          y: d.violations,
        })),
      },
          ...
          >
            ...
            <div className="p-3 bg-gray-50 border-t border-gray-100">
              <div className="flex items-center justify-between text-xs text-gray-500">
                <span>
                  Showing {visibleCount} of {totalCharts} charts
                </span>
                <motion.button
...
const DashBoard = () => {
  ...
  const toggleAllCharts = () => {
    ...
    const newState = chartConfigs.reduce(
      (acc, chart) => ({
        ...acc,
        [chart.id]: !allVisible,
      }),
  ...
  const exportToExcel = () => {
    ...
    XLSX.writeFile(
      workbook,
      `AI_Misuse_Report_${new Date().toISOString().split("T")[0]}.xlsx`
    );
  };
